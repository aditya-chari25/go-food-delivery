...
type DeliveryServiceClient interface {
	CreateDelivery(ctx context.Context, in *DeliveryRequest, opts ...grpc.CallOption) (*DeliveryResponse, error)
}
...
func (c *deliveryServiceClient) CreateDelivery(ctx context.Context, in *DeliveryRequest, opts ...grpc.CallOption) (*DeliveryResponse, error) {
...
type DeliveryServiceServer interface {
	CreateDelivery(context.Context, *DeliveryRequest) (*DeliveryResponse, error)
...
func (UnimplementedDeliveryServiceServer) CreateDelivery(context.Context, *DeliveryRequest) (*DeliveryResponse, error) {
...
func _DeliveryService_CreateDelivery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeliveryServiceServer).CreateDelivery(ctx, req.(*DeliveryRequest))
	}
...
var DeliveryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/proto/delivery.proto",
}
