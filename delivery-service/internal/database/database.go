...
type service struct {
	...
	mongoCollectionDeliveryDrivers *mongo.Collection
	mongoCollectionAuthDrivers    *mongo.Collection
}
...
var (
	...
	mongoCollDelDrivers = os.Getenv("MONGO_COLLDD")
	mongoCollAuthDrivers = os.Getenv("MONGO_COLLDA")
	dbInstance *service
)
...
func New() Service {
	...
	dbInstance = &service{
		...
		mongoCollectionDeliveryDrivers: mongoCollectionRestaurant,
		mongoCollectionAuthDrivers:     mongoCollectionOrders,
	}
	return dbInstance
}
